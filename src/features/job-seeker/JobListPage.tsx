...
export function JobListPage() {
  ...
  return <>
    <header className="page-heading"><p className="eyebrow">Peluang Karier</p><h1>Lowongan Pekerjaan</h1>
      <p>Temukan peluang kerja yang sesuai untuk Anda.</p></header>
    ...
    {state === 'ready' && jobs.length === 0 && <section className="state-card"><h2>Belum ada lowongan</h2>
      <p>Saat ini belum ada lowongan pekerjaan yang tersedia.<br />Silakan periksa kembali nanti.</p></section>}
